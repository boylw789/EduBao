...
public class ExpandableLayout extends FrameLayout {
	...
	private void init(AttributeSet attrs) {
		if (attrs != null) {
			...
			duration = a.getInt(R.styleable.ExpandableLayout_el_duration,
					DEFAULT_DURATION);
			expanded = a.getBoolean(R.styleable.ExpandableLayout_el_expanded,
					false);
			orientation = a.getInt(
					R.styleable.ExpandableLayout_android_orientation, VERTICAL);
			a.recycle();
		}
